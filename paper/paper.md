...
There have been multiple approaches proposed to perform said decomposition [@williams2010; @griffith2014; @bertschinger2014; @james2018a]. Here we focus on the approach proposed by [@williams2010] primarily because this package implements PID for two and three source decomposition, and as of now, this is the only approach that guarantees non-negative decomposition for the four variable case (one target and three sources).
